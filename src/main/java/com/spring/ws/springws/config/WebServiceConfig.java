package com.spring.ws.springws.config;
...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema personSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://www.xpadro.spring.samples.com/employees");
        wsdl11Definition.setServiceName("EmployeesPortService");
